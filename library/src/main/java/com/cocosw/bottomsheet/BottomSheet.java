...
public class BottomSheet extends Dialog implements DialogInterface {
	...
	private void init(Context context) {
		...
		if (menuItem.size() > builder.limit) {
			...
			menuItem.add(new MenuItem(R.id.bs_more, "More", context.getResources().getDrawable(R.drawable
					.bs_ic_more), builder.getDefaultTextAppearance()));
		}
		actions = menuItem;
